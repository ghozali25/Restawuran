                    ...
                    <div class="card">
                        ...
                        <div class="card-body add-post">
                            ...
                            <form class="row" method="POST"
                                action="{{ route('admin.tables.update', $table->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" id="name" name="name"
                                                    value="{{ $table->name }}" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" id="price" name="guest_number"
                                                    value="{{ $table->guest_number }}" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
