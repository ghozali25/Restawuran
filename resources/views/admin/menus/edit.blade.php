            ...
            <div class="page-title">
                <div class="card card-absolute mt-5 mt-md-4">
                    <div class="card-header bg-primary">
                        <h5 class="text-white">🍕 • Edit Menu </h5>
                    </div>
                    <div class="card-body">
                        <p>
                            Dibawah ini adalah halaman untuk edit menu. <span class="d-none d-md-inline">
                                Menu yang telah kamu edit nantinya muncul di halaman landing page
                    ...
                    <div class="card">
                        ...
                        <div class="card-body add-post">
                            ...
                            <form class="row" method="POST"
                                action="{{ route('admin.menus.update', $menu->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="col-sm-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" id="name" name="name"
                                                    value="{{ $menu->name }}" type="text" required="">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input class="form-control" id="price" name="price"
                                                    value="{{ $menu->price }}" type="text" required="">
                                            </div>
                                        </div>
